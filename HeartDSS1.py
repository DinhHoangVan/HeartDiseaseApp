...
def user_input_features():
    model = st.sidebar.selectbox('Model', ('Logistic Regression', 'SVC', 'Random Forest','Xgboost'))


    Age = st.sidebar.slider('Age', 20, 105, 70)
...
if model == 'Logistic Regression':
    ...
    load_clf = pickle.load(open('RF_HF.pkl', 'rb'))
elif model == 'Xgboost':
...
if model == 'Random Forest':
    ...
    st.subheader('Xgboost Coefficients')
